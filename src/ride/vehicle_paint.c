...
void vehicle_paint(rct_vehicle *vehicle, int imageDirection)
{
	...
	case VEHICLE_VISUAL_MINI_GOLF_PLAYER:				vehicle_visual_mini_golf_player(x, imageDirection, y, z, vehicle, rct2VehiclePtrFormat, 0); break;
	case VEHICLE_VISUAL_MINI_GOLF_BALL:					vehicle_visual_mini_golf_ball(x, imageDirection, y, z, vehicle, rct2VehiclePtrFormat, 0); break;
